...
│  │  ├─ URL: git+https://github.com/vuejs/core.git
│  │  ├─ VendorName: Evan You
│  │  └─ VendorUrl: https://github.com/vuejs/core/tree/main/packages/compiler-ssr#readme
...
│  │  └─ URL: https://github.com/chalk/chalk-template.git
│  ├─ chalk@2.4.2
...
│  │  └─ VendorUrl: https://sindresorhus.com
│  ├─ clipboardy@2.3.0
│  │  ├─ URL: https://github.com/sindresorhus/clipboardy.git
│  │  ├─ VendorName: Sindre Sorhus
│  │  └─ VendorUrl: sindresorhus.com
│  ├─ clipboardy@3.0.0
│  │  ├─ URL: https://github.com/sindresorhus/clipboardy.git
...
│  ├─ consolidate@0.15.1
│  │  ├─ URL: https://github.com/tj/consolidate.js.git
│  │  ├─ VendorName: TJ Holowaychuk
│  │  └─ VendorUrl: https://github.com/tj/consolidate.js
...
│  │  ├─ VendorName: Len Boyette
│  │  └─ VendorUrl: https://github.com/webpack-contrib/copy-webpack-plugin
...
│  │  ├─ VendorName: Brandon Nozaki Miller
│  │  └─ VendorUrl: https://github.com/RIAEvangelist/easy-stack#readme
│  ├─ ee-first@1.1.1
...
│  │  ├─ VendorName: Toru Nagashima
│  │  └─ VendorUrl: https://eslint.vuejs.org/
│  ├─ eslint-utils@2.1.0
...
│  │  ├─ VendorName: Petka Antonov
│  │  └─ VendorUrl: https://github.com/petkaantonov/urlparser
│  ├─ figures@2.0.0
...
│  │  └─ VendorUrl: https://github.com/bevacqua/hash-sum
│  ├─ hash-sum@2.0.0
│  │  ├─ URL: git://github.com/bevacqua/hash-sum.git
│  │  └─ VendorUrl: https://github.com/bevacqua/hash-sum
│  ├─ he@1.2.0
...
│  │  └─ VendorUrl: https://github.com/davidmarkclements/is-file-esm#readme
...
│  │  ├─ URL: https://github.com/sindresorhus/is-port-reachable.git
│  │  ├─ VendorName: Sindre Sorhus
│  │  └─ VendorUrl: https://sindresorhus.com
│  ├─ is-stream@1.1.0
...
│  │  ├─ VendorName: Blake Embrey
│  │  └─ VendorUrl: https://github.com/blakeembrey/javascript-stringify
│  ├─ jest-worker@27.5.1
...
│  │  ├─ VendorName: Brandon Nozaki Miller
│  │  └─ VendorUrl: https://github.com/RIAEvangelist/js-message#readme
│  ├─ js-tokens@4.0.0
...
│  │  ├─ VendorName: Evan You
│  │  └─ VendorUrl: https://github.com/yyx990803/launch-editor#readme
│  ├─ launch-editor@2.6.0
│  │  ├─ URL: git+https://github.com/yyx990803/launch-editor.git
│  │  ├─ VendorName: Evan You
│  │  └─ VendorUrl: https://github.com/yyx990803/launch-editor#readme
...
│  │  ├─ VendorName: Nick Gavrilov
│  │  └─ VendorUrl: https://github.com/ilearnio/module-alias
│  ├─ mrmime@1.0.1
...
│  │  ├─ VendorName: alichen
│  │  └─ VendorUrl: https://github.com/ali322/progress-webpack-plugin#readme
│  ├─ progress@2.0.3
...
│  │  └─ VendorName: Douglas Christopher Wilson
│  ├─ serve@14.2.0
│  │  └─ URL: https://github.com/vercel/serve.git
│  ├─ shallow-clone@3.0.1
...
│  ├─ spdx-compare@1.0.0
│  │  ├─ URL: https://github.com/kemitchell/spdx-compare.js.git
│  │  ├─ VendorName: Kyle E. Mitchell
│  │  └─ VendorUrl: https://kemitchell.com
...
│  │  ├─ URL: https://github.com/kemitchell/spdx-satisfies.js.git
│  │  ├─ VendorName: Kyle E. Mitchell
│  │  └─ VendorUrl: https://kemitchell.com
...
│  │  ├─ VendorName: Tobias Koppers @sokra
│  │  └─ VendorUrl: https://github.com/webpack-contrib/thread-loader
│  ├─ thunky@1.1.0
...
│  │  ├─ VendorName: Nguyen Quoc Anh
│  │  └─ VendorUrl: https://github.com/imcvampire/vue-axios#readme
│  ├─ vue-eslint-parser@8.3.0
│  │  ├─ URL: git+https://github.com/vuejs/vue-eslint-parser.git
│  │  ├─ VendorName: Toru Nagashima
│  │  └─ VendorUrl: https://github.com/vuejs/vue-eslint-parser#readme
│  ├─ vue-hot-reload-api@2.3.4
│  │  ├─ URL: git+https://github.com/vuejs/vue-hot-reload-api.git
│  │  ├─ VendorName: Evan You
│  │  └─ VendorUrl: https://github.com/vuejs/vue-hot-reload-api#readme
│  ├─ vue-loader@17.0.1
│  │  ├─ URL: https://github.com/vuejs/vue-loader.git
│  │  └─ VendorName: Evan You
...
│  │  ├─ URL: git+https://github.com/cloudeep/vuejs-paginate-next
│  │  ├─ VendorName: Neil Perng
│  │  └─ VendorUrl: https://github.com/cloudeep/vuejs-paginate-next#readme
│  ├─ watchpack@2.4.0
...
│  │  ├─ VendorName: Yury Grunin
│  │  └─ VendorUrl: https://github.com/webpack-contrib/webpack-bundle-analyzer
...
│     └─ VendorUrl: https://github.com/yyx990803/yorkie
├─ MPL-2.0
│  └─ webpack-chain@6.5.1
│     ├─ URL: https://github.com/neutrinojs/webpack-chain.git
│     └─ VendorName: Eli Perelman
└─ Unlicense
   ├─ event-pubsub@4.3.0
   │  ├─ URL: https://github.com/RIAEvangelist/event-pubsub.git
   │  ├─ VendorName: Brandon Nozaki Miller
   │  └─ VendorUrl: https://github.com/RIAEvangelist/event-pubsub
   ├─ fs-monkey@1.0.3
